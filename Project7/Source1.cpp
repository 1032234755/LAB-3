...
#define _USE_MATH_DEFINES // Определяем макрос для использования констант из cmath
...
protected:
    double width, height;
public:
    Rectangle(double x = 0, double y = 0, double width = 1, double height = 1) : Point(x, y), width(width), height(height) {} // Конструктор с параметрами по умолчанию
    void draw() const override {
...
public:
    Square(double x = 0, double y = 0, double side = 1) : Rectangle(x, y, side, side) {} // Конструктор с параметрами по умолчанию
    void draw() const override {
...
public:
    Parallelogram(double x = 0, double y = 0, double width = 1, double height = 1, double angle = 0) : Rectangle(x, y, width, height), angle(angle) {}
    void draw() const override {
...
public:
    Rhombus(double x = 0, double y = 0, double side = 1, double angle = 0) : Parallelogram(x, y, side, side, angle) {}
    void draw() const override {
